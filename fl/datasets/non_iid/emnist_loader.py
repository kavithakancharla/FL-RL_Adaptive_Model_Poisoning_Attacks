...
def get_non_iid_emnist_dataloader(num_clients=10, num_classes_per_client=2, batch_size=32):
    transform = transforms.Compose([transforms.ToTensor()])
    dataset = EMNIST(root="./data", train=True, download=True, transform=transform)
